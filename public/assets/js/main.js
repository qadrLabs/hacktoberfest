...
let initialContributorsNumber = 12;
...
if (contributors.length <= initialContributorsNumber) {
...
function loadMore() {
    if (initialContributorsNumber >= contributors.length) {
        // Semua kontributor sudah ditampilkan, tidak perlu menambah lagi
        document.getElementById("loadMore").setAttribute("hidden", true);
    } else {
        // Tampilkan semua kontributor yang tersisa
        initialContributorsNumber = contributors.length;
        ...
        // Sembunyikan tombol "Load More" karena semua kontributor sudah ditampilkan
        document.getElementById("loadMore").setAttribute("hidden", true);
    }
}
